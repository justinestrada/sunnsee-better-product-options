            ...
            <div class="row">
              ...
              <div class="tab-content py-4" id="customizeGlassesTabContent">
                      ...
                      <label for="color_rain" class="card">
                        ...
                        <div class="card-body text-center">
                          <div>
                            ...
                            <p class="card-price mb-0" style="display: none;">$45</p>
                          </div>
                        </div>
                      </label>
                    </li>
                ...
                <div class="tab-pane fade py-4" id="vision" role="tabpanel" aria-labelledby="vision-tab">
                  <div id="vision-content">
                        ...
                        <label for="vision_progressive" class="card h-100">
                          ...
                          <div class="card-body d-flex align-items-center">
                            <div>
                              ...
                              <p class="card-text">Advanced digitally surfaced progressive lenses that correct distance, intermediate, and near vision in a gradual, no-line, single lens.</p>
                            </div>
                          </div>
                        </label>
                      </li>
                    ...
                    <div id="prescription-fields-wrap" class="mb-4" style="display: none;">
                      ...
                      <div class="row mb-3">
                        <div class="col-5 col-lg-4 offset-lg-1 text-center">
                        ...
                        <div class="col-5 col-lg-4 text-center">
                          <button type="button" id="btn-perscription-manually" class="btn btn-outline-primary">Enter Manually</button>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col text-center">
                ...
                <div class="tab-pane fade py-4" id="lenses" role="tabpanel" aria-labelledby="vision-tab">
                  ...
                  <div id="select-lens-coating" style="display: none;">
                    <div class="text-center">
                    ...
                    <ul id="lens-coating" class="checkbox-options-wrap row mb-4">
                      <li class="col-md-4 mb-3 mb-md-0">
                        ...
                        <label for="lens_coating_ar" class="card h-100">
                          <div class="card-body text-center">
                            <div>
                              <h5 class="card-title">SunNSee AR</h5>
                              <p class="card-included">Included</p>
                      ...
                      <li class="col-md-4 mb-3 mb-md-0">
                        ...
                        <label for="lens_coating_blue_filter" class="card h-100">
                          <div class="card-body text-center">
                            <div>
                              <h5 class="card-title">Blue Filter</h5>
                      ...
                      <li class="col-md-4 mb-3 mb-md-0">
                        <input type="checkbox" id="lens_coating_transitions" name="lens_coating" value="transitions"/>
                        <label for="lens_coating_transitions" class="card h-100">
                          <div class="card-body text-center">
                            <div>
                              <h5 class="card-title">Transitions<sup>&reg;</sup></h5>
                  ...
                  <table id="review-table" class="table-responsive table mb-4">
                    <tbody>
                      <tr>
                        ...
                        <td id="review-color_price" class="review-price"></td>
                        <td class="review-remove"></td>
                      </tr>
                      <tr>
                        <td>Vision Type</td>
                        <td id="review-vision-type" class="review-value">{vision_type}</td>
                        <td id="review-vision-type_price" class="review-price"></td>
                        <td class="review-remove"></td>
                      </tr>
                      <tr id="review-prescription-type">
                        <td>Prescription Type</td>
                        <td id="review-prescription-type_value" class="review-value">{prescription_type}</td>
                        <td id="review-prescription-type_price" class="review-price"></td>
                        <td class="review-remove"></td>
                      </tr>
                      <tr id="review-lens-material">
                        <td>Lens Material</td>
                        <td id="review-lens-material_value" class="review-value">{lens_material}</td>
                        <td id="review-lens-material_price" class="review-price"></td>
                        <td class="review-remove"></td>
                      </tr>
                      <tr id="review-lens-coating">
                        <td>Lens Coating</td>
                        <td id="review-lens-coating_value" class="review-value">{lens_coating}</td>
                        <td id="review-lens-coating_price" class="review-price"></td>
                        <td id="review-lens-coating_remove" class="review-remove-td text-center"></td>
                      </tr>
                    </tbody>
                  </table>
                  <div class="row">
